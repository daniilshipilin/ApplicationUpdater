...
public class Updater : IUpdater
{
        ...
        string exeLaunchPath)
    {
        ...
        {
            throw new ArgumentNullException(nameof(exeLaunchPath));
        }

        if (string.IsNullOrEmpty(AppSettings.AppVersionsUrl))
        {
            throw new NullReferenceException(nameof(AppSettings.AppVersionsUrl));
        }
        ...
        this.appVersionsUrl = AppSettings.AppVersionsUrl;
    }
    ...
    public async Task<bool> CheckUpdateIsAvailable()
    {
        ...
        if (response.IsSuccessStatusCode)
        {
            ...
            var obj = JsonSerializer.Deserialize<AppVersionsJson>(data);
